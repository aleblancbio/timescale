...
#'
setGeneric("timeScale", function(x1, x2, model , conditions, param = list(), control = list(), interpolation = "linear") standardGeneric("timeScale"))
setMethod("timeScale", signature(x1 = "numeric", x2 = "numeric", model = "character", conditions = "data.frame", interpolation = "character"), function(x1, x2, model, conditions, param, control, interpolation) {
  ...
  #Integration
  xScaled <- vectIntegrate(f = compModel, lower = x1,upper = x2)
