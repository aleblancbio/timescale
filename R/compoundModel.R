...
#' @description Generate the compound function of the model and its variable represented as functions, through condModel a list a function  reprensenting each variables.
#' @param condModel \code{list} of functions that represent conditions variables in function of time (\code{v}) as the only argument. The \code{names} attribute of the list correspond to the variable names.
...
#' g(x)
#' 
setGeneric("compoundModel", function(model, condModel, param = list(), control = list())  standardGeneric("compoundModel"))
setMethod("compoundModel", signature(model = "character", condModel = "list"), function(model, condModel, param, control) {
  #Validity
  ...
  #Generate the compound function of the model and its variables in function of time (x).
